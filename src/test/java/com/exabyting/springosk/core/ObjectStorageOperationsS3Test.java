...
@Testcontainers
@SpringBootTest(classes = {S3Config.class, PropertiesConfig.class, ObjectStorageOperations.class, com.exabyting.springosk.s3.S3BucketOperations.class, com.exabyting.springosk.s3.S3ObjectOperations.class})
@DisplayName("ObjectStorageOperations S3 Integration Tests with TestContainers")
@Slf4j
class ObjectStorageOperationsS3Test {
