...
@Testcontainers
@SpringBootTest(classes = {MinioConfig.class, PropertiesConfig.class, ObjectStorageClient.class, com.exabyting.springosk.minio.MinIOBucketOperations.class, com.exabyting.springosk.minio.MinIOObjectOperations.class})
@DisplayName("ObjectStorageOperations MinIO Integration Tests with TestContainers")
@Slf4j
class ObjectStorageClientMinIOTest {
    ...
    void testConcurrentOperations() {
        ...
        Boolean result1 = objectStorageClient.putObject(TEST_BUCKET_NAME_1, "concurrent-obj-1.txt", content1);
        Boolean result2 = objectStorageClient.putObject(TEST_BUCKET_NAME_1, "concurrent-obj-2.txt", content2);
        Boolean result3 = objectStorageClient.putObject(TEST_BUCKET_NAME_1, "concurrent-obj-3.txt", content3);
    ...
    void testBucketWithManyObjects() {
        ...
        for (int i = 0; i < objectCount; i++) {
            ...
            Boolean result = objectStorageClient.putObject(TEST_BUCKET_NAME_1, objectKey, contentBytes);
